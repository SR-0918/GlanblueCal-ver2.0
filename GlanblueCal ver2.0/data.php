...
$rupi = new glanblueCal('ルピ', 100000, 'GlanblueCalculater_image/rupi.png' );
...
$hekirei = new glanblueCal('碧麗の証', 1, 'GlanblueCalculater_image/hekirei.png');
...
$menus = array($decayWepons, $damasucusHopperCrystal, $starPiece, $halo, $sixDragons, $silverPiece, $goldNugget, $jewel, $jine, $rupi, $magnaAnima, $pushuke, $tenseiPiece, $bahamutePupleHone, $kyuukyou, $hekirei, $shumatsu, $kyokushi, $makaku);
